  ...
  return (
    <Section className="px-6 py-10 bg-lightGray md:px-12 lg:px-16 xl:px-28 xxl:px-44">
      <form
        ...
        <div className='absolute top-0 right-0 -z-[1] lg:-bottom-0 lg:left-0'>
        ...
        <div className={`transition-all flex flex-col ${error ? "gap-11 lg:gap-4" : "gap-5 md:gap-7"}
          ...
          <Button 
            type="submit" 
            className="w-full transition-all rounded-[8px] py-4 text-lg md:text-2xl lg:text-xl  lg:w-[20%] lg:ml-auto lg:px-6"
          ...
          {longUrlArray.map((long, i) => (
            <div key={i} className='bg-white mb-4 md:mb-6 py-4
              ...
              <div className='pb-4 border-b-[1px] border-grayish-violet lg:border-none lg:p-0 md:pb-8'>
                <a 
                  className='px-4 md:px-8 text-very-dark-violet lg:p-0' 
                  href={long} 
                  target='_blank'
                >
                  {long}
      ...
      <div className='pt-10 md:py-16 pb-4 lg:pt-20 xl:pb-8 text-center'>
