  ...
  return (
    <Section className="sm:overflow-x-hidden md:overflow-y-visible bg-white md:px-12
     md:flex md:gap-16 lg:gap-10 md:items-center lg:px-16 lg:pb-12 md:pb-52 xl:pb-8
      ...
      <section className='h-[320px] w-[500px] ml-6 md:order-1 md:absolute 
      ...
      <section className='text-center lg:text-left py-10 px-6 mt-5 md:p-0 
        pb-40 lg:w-[500px] md:w-[380px] xl:w-[570px] md:text-left'>
        <h2 className='text-4xl font-bold md:text-5xl xl:text-6xl leading-tight
          xl:leading-tight'>More than just shorter links</h2>
